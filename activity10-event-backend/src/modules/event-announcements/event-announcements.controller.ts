...
export class EventAnnouncementsController {
  constructor(private readonly eventAnnouncementsService: EventAnnouncementsService) {}

  // Create a new event announcement
  @Post()
  @ApiOperation({ summary: 'Create a new event announcement' })
  @ApiResponse({ status: 201, description: 'The created event announcement', type: CreateEventAnnouncementDto })
  ...
  @ApiResponse({ status: 200, description: 'List of event announcements', type: [CreateEventAnnouncementDto] })
  findAll() {
  ...
  @ApiResponse({ status: 200, description: 'The event announcement', type: CreateEventAnnouncementDto })
  ...
  @ApiResponse({ status: 200, description: 'The updated event announcement', type: CreateEventAnnouncementDto })
  update(@Param('id') id: string, @Body() updateEventAnnouncementDto: UpdateEventAnnouncementDto) {
  ...
  @ApiResponse({ status: 200, description: 'The deleted event announcement', type: CreateEventAnnouncementDto })
